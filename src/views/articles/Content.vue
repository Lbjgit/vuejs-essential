        ...
        <div class="voted-users">
          <div class="user-lists">
            <span v-for="likeUser in likeUsers">
              ...
              <router-link :to="`/${likeUser.uname}`" :src="likeUser.uavatar" tag="img" class="img-thumbnail avatar avatar-middle" :class="{ 'animated animate__bounceIn' : likeUser.uid === 1 }"></router-link> 
            </span>
          </div>
    ...
    like(e) {
      if (!this.auth) {
        ...
        if (active) {
          ...
          this.likeClass = 'active animated animate__bounceIn'
